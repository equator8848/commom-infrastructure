...
public class SM4 {
    ...
    protected void sm4_setkey_enc(SM4Context ctx, byte[] key) throws Exception {
        if (ctx == null) {
    ...
    protected void sm4_setkey_dec(SM4Context ctx, byte[] key) throws Exception {
        if (ctx == null) {
            throw new Exception("ctx is null!");
        } else if (key != null && key.length == 16) {
            ctx.mode = 0;
    ...
    protected byte[] sm4_crypt_ecb(SM4Context ctx, byte[] input) throws Exception {
        if (input == null) {
    ...
    protected byte[] sm4_crypt_cbc(SM4Context ctx, byte[] iv, byte[] input) throws Exception {
