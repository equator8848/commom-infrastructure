...
public class SM4BaseUtil {
    static {
        Security.addProvider(new BouncyCastleProvider());
    }

    protected static byte[] SG_EncECBData(byte[] keyBytes, byte[] plainText) {
    ...
    protected static byte[] SG_DecECBData(byte[] keyBytes, byte[] cipherText) {
        if (keyBytes != null && keyBytes.length == 16) {
